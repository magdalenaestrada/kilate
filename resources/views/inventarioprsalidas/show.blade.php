                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 g-3">
                                ...
                                @if($inventarioprestamosalida->usuario_devol_confirm)
                                <input class="form-control" value="{{ $inventarioprestamosalida->usuario_devol_confirm }}"
                                    disabled>
                                @else
                                <input class="form-control" value="Aún no nos devuelven los artículos prestados" style="color:red"
                                    disabled>
                                @endif                            
                            </div>
                            @endif
