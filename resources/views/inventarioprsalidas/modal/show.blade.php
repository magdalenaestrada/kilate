<div class="modal fade text-left" id="ModalShow{{ $prestamosalida->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 g-3">
                                <label for="estado" class="text-sm">
                                    {{ __('ESTADO DEL PRESTAMO ENVIADO A ') }} <strong>{{ $prestamosalida->destino }}</strong>
                                </label>
                            ...
                            @if($prestamosalida->condicion == 'CON DEVOLUCIÓN')
                            <div class="form-group col-md-6 g-3">
                                <label for="" class="text-sm">
                                    {{ __('RECEPTOR DE LA DEVOLUCIÓN') }}
                                </label>

                                @if($prestamosalida->usuario_devol_confirm)
                                <input class="form-control form-control-sm" value="{{ $prestamosalida->usuario_devol_confirm }}"
                                    disabled>
                                @else
                                <input class="form-control form-control-sm" value="Aún no nos devuelven los artículos prestados" style="color:red"
                                    disabled>
                                @endif                            
                            </div>
                            @endif
