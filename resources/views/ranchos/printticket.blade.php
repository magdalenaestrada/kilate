...
<body>
    ...
    <div class="container">
    <br>
        <p class="text-center mr-1" style="margin-bottom: -5px">KILATE CORPORATION S.A.C</p>



        <p class="text-center" style="margin-bottom: -5px">{{ __('TICKET') }} KILATE CORPORATION - {{ $rancho->id }}</p>
