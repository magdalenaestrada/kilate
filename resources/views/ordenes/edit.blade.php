    ...
    <div class="container mt-4">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">EDITAR ORDEN DE SERVICIO - {{ $orden->codigo }}</h5>
                <a href="{{ route('orden-servicio.index') }}" class="btn btn-secondary btn-sm">Volver</a>
            </div>

            <div class="card-body">
                <form action="{{ route('orden-servicio.update', $orden->id) }}" method="POST" id="formOrdenServicio">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" name="fecha_fin" id="fecha_fin" class="form-control" required
                                value="{{ optional($orden->fecha_fin)->format('Y-m-d') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="descripcion" id="descripcion" class="form-control" rows="2"
                            placeholder="Ej. Servicio de mantenimiento de equipos">{{ $orden->descripcion }}</textarea>
                    </div>
                        ...
                        <tbody id="tbodyServicios">
                            @foreach ($orden->detalles as $detalle)
                                <tr>
                                    ...
                                    <td><input type="number" class="form-control cantidad" min="1"
                                            value="{{ $detalle->cantidad }}" required></td>
                                    <td><input type="number" class="form-control precio_unitario" step="0.01"
                                            value="{{ $detalle->precio_unitario }}" required></td>
                                    <td><input type="number" class="form-control subtotal" step="0.01" readonly
                                            value="{{ $detalle->cantidad * $detalle->precio_unitario }}"></td>
                    ...
                    <div class="row justify-content-end mb-3">
                        <div class="col-md-3">
                            ...
                            <input type="number" value="{{ $orden->costo_estimado }}" name="costo_estimado"
                                id="costo_estimado" class="form-control" readonly>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn btn-success">Actualizar Orden de Servicio</button>
                    </div>
                </form>
            </div>
        </div>
