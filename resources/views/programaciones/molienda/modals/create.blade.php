  <div class="modal fade" id="modalMolienda" tabindex="-1" aria-labelledby="modalMoliendaLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
          <div class="modal-content border-0 shadow-lg rounded-4">
              <div class="modal-header bg-light border-0">
                  <h5 class="modal-title fw-semibold" id="modalMoliendaLabel">Editar molienda</h5>
              </div>

              <div class="modal-body bg-light">
                  <form id="formMolienda">
                      @csrf
                      <input type="hidden" id="molienda_id" value="">
                      <div class="row g-2">
                          <div class="col-md-4">
