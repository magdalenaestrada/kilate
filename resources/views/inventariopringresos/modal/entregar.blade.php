<div class="modal fade text-left" id="ModalEntregar{{ $prestamoingreso->id }}" tabindex="-1" role="dialog"
    aria-hidden="true">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 g-3">
                        <label for="inventarioingreso_fin" class="text-sm">
                            {{ __('ESTADO DEL PRESTAMO RECIBIDO') }}
                        </label>
                    ...
                    <div class="form-group col-md-6 g-3">
                        ...
                        <input class="form-control" value="{{ $prestamoingreso->usuario_creador }}" disabled>
                    </div>
                    ...
                    <div class="form-group col-md-6 g-3">
                        ...
                        <input class="form-control" type="text" value="{{ $prestamoingreso->condicion }}" disabled>
                    </div>
                    ...
                    <div class="form-group col-md-4 g-3">
                        ...
                        <div class="input-group">
                            <input class="form-control form-control-sm" value="{{ $prestamoingreso->documento_responsable }}" disabled>
                    ...
                    <div class="col-md-12 text-right">
                        <form action="{{ route('inventarioprestamoingreso.update', $prestamoingreso->id) }}"
                            method="POST">
                            @csrf
                            @method('PUT')

                            
                                <button type="submit" class="mt-1 btn btn-sm btn-warning" style="margin-right: -8px; margin-bottom: -20px">
                                    {{ __('CONFIRMAR ENTREGA DEL PRESTAMO') }}
                                </button>
