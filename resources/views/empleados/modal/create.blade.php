<div class="modal fade text-left" id="ModalCreate"  role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="card-body">
                <form class="crear-empleado" action="{{ route('empleados.store') }}" method="POST">
                    @csrf
                    <div class="row">


                        <div class="form mb-1 col-md-4">
                            <input name="documento" id="documento" class="input form-control" placeholder="Documento del empleado..." required="" type="text">
                            <span class="input-border"></span>
                        </div>   
    
                        <div class="form col-md-8">
                            <input name="nombre" id="nombre" class="input form-control" placeholder="Valide el nombre del empleado" required="" type="text">
                            <span class="input-border"></span>
                        </div>   
                        ...
                        <div class="form-group col-md-12 g-3">
                            <label for="empleado" class="text-muted">
                                {{ __('JEFE') }}
                            </label>
                            <br>
                            <select name="jefe_id" id="empleado" class=" form-control buscador @error('empleado') is-invalid @enderror" aria-label="" style="width: 100%">
                                <option selected disabled>
                                    Seleccione al jefe del empleado
                                </option>
                        ...
                        <div class="form-group col-md-12 g-3">
                            <label for="area" class="text-muted">
                                {{ __('AREA') }}
                            </label>
                            <br>
                            <select name="area_id" id="area" class=" form-control buscador @error('area') is-invalid @enderror" aria-label="" style="width: 100%" required>
                                <option selected value="">
                                    Seleccione el área del empleado
                                </option>
                        ...
                        <div class="form-group col-md-12 g-3">
                            <label for="posicion" class="text-muted">
                                {{ __('POSICIÓN') }}
                            </label>
                            <br>
                            <select name="posicion_id" id="posicion" class=" form-control buscador @error('posicion') is-invalid @enderror" aria-label="" style="width: 100%">
                                <option selected value="">
                                    Seleccione la posición del empleado
                                </option>
                                @foreach ($posiciones as $posicion)
                                    <option value="{{ $posicion->id }}" {{ old('area') == $posicion->id ? 'selected' : '' }}>
                                        {{ $posicion->nombre }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form mb-2  col-md-12">
                            <input name="email" id="email" class="input form-control" placeholder="Email del usuario..." required="" type="email">
                            <span class="input-border"></span>
                        </div>   
    
                        <div class="form mb-3 col-md-12">
                            <input name="password" id="password" class="input form-control" placeholder="Contraseña del usuario..." required="" type="text">
                            <span class="input-border"></span>
                        </div> 
