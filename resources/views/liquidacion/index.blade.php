...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center align-items-center">
                                            @if ($proceso->estado == 'L')
                                                <div class="d-flex justify-content-center align-items-center">
                                                    <button onclick="imprimirLiquidacion({{ $proceso->liquidacion?->id }})">
                                                        IMPRIMIR
                                                    </button>

                                                </div>
                                            @elseif ($proceso->estado == 'F')
                                                <a href="{{ route('liquidaciones.create', $proceso->id) }}"
    ...
    <script>
        ...
        function imprimirLiquidacion(liquidacionId) {
            ...
            const url = "{{ route('liquidaciones.print', ':id') }}".replace(':id', liquidacionId);
            iframe.src = url;
