        ...
        <tr>
            ...
            @can('edit cuenta')
                <td class="btn-group align-items-center">
                    ...
                    <a href="{{ route('lqliquidaciones.printdoc', $liquidacion->id) }}" class="btnprn"
                    ...
                    <a style="margin: 2px " href="{{ route('lqliquidaciones.show', [$liquidacion->id]) }}"
                        ...
                        <div class="">
                            <form class="eliminar-registro"
                                action="{{ route('lqliquidaciones.destroy', $liquidacion->id) }}" method="POST"
                                style="display:inline;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="bin-button btn anular eliminar-registro">
                                    <!-- SVG Icon -->
