...
@section('content')
    <div class="container">
        ...
        <div class="row d-flex justify-content-between align-items-center">
            <div class="loader">
                {{ __('REPOSICIONES REGISTRADAS EN LAS CAJAS') }}
                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                Mostrando del {{ $reposicionescajas->firstItem() }} al
                                {{ $reposicionescajas->lastItem() }} de {{ $reposicionescajas->total() }} registros
                            </div>
                        </div>
    ...
    @include('tesoreria.reposicionescajas.modal.create')
    @include('tesoreria.reposicionescajas.modal.export')

    @foreach ($reposicionescajas as $reposicioncaja)
        @include('tesoreria.reposicionescajas.modal.editreposicion')
    @endforeach
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#searcht').on('input', function(e) {
                ...
                $.ajax({
                    url: "{{ route('search.tsreposicionescajas') }}",
                    method: 'GET',
                    data: {
        ...
        $('.eliminar-registro').submit(function(e) {
            e.preventDefault();
            Swal.fire({
                title: '¿Eliminar reposición de la caja?',
                text: 'Esta seguro que quiere eliminar esta reposición a la caja?',
                icon: 'warning',
