<form method="POST" action="{{ route('tsbancos.store') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form">
                        <input name="nombre" class=" form-control form-control-sm" placeholder="Ingrese el nombre del banco" required="" type="text">
