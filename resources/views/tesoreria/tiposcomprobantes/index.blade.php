...
@section('content')
                        ...
                        <table id="posiciones-table" class="table table-striped  ">
                                        ...
                                        <tr >
                                            ...
                                            {{-- <td class="btn-group">
                                                ...
                                                <a href="#" data-toggle="modal"
                                                    data-target="#ModalEdit{{ $tipocomprobante->id }}" class="ml-1">
                         ...
                         <!-- Pagination Links -->
                            <div class="d-flex justify-content-between">
                                <div>
                                    {{ $tiposcomprobantes->links('pagination::bootstrap-4') }}
                                </div>
                                <div>
                                    Mostrando del {{ $tiposcomprobantes->firstItem() }} al {{ $tiposcomprobantes->lastItem() }} de {{ $tiposcomprobantes->total() }} registros
                                </div>
                            </div>
    ...
    @include('tesoreria.tiposcomprobantes.modal.create')
