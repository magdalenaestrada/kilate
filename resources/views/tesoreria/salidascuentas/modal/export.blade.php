        ...
        <div class="modal-content">
            ...
            <div class="card-header">
                <div class="row justify-content-between">
                    <div class="col-md-6">
                        <h6 class="mt-2">
                            {{ __('REPORTE DE SALIDAS DE LAS CUENTAS') }}
                        </h6>
                    </div>
            ...
            <div class="card-body">
                <form class="crear-accion" action="{{ route('tssalidascuentas.export-excel') }}" method="GET">
                    @csrf
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 g-3">
                            ...
                            <br>
                            <select name="motivo_id" id="motivo3" class="form-control buscador @error('motivo3') is-invalid @enderror" aria-label="" style="width: 100%" >
                        ...
                        <div class="form-group col-md-6 g-3">
                            ...
                            <br>
                            <select name="cuenta_id" id="cuenta3" class="form-control buscador @error('cuenta') is-invalid @enderror" aria-label="" style="width: 100%" >
                                <option selected value="">
