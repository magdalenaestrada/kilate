                ...
                <form class="crear-cuenta" action="{{ route('tssalidascuentas.depositar') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 g-3">
                            ...
                            <br>
                            <select name="cuenta_id" id="cuenta1" class="form-control form-control-sm buscador @error('cuenta') is-invalid @enderror" aria-label="" style="width: 100%" required="">
                                <option selected value="">
                                    Seleccione la cuenta de origen
                                </option>
                                @foreach ($cuentas as $cuenta)
                                    @if($cuenta->tipomoneda->nombre == 'SOLES')
                                    <option value="{{ $cuenta->id }}" {{ old('cuenta') == $cuenta->id ? 'selected' : '' }}>
                                        {{ $cuenta->nombre }}
                                    </option>
                                    @endif
                                @endforeach
                        ...
                        <div class="form-group col-md-6 g-3">
                            ...
                            <br>
                            <select name="cuenta_beneficiaria_id" id="cuenta_beneficiaria" class="form-control form-control-sm buscador @error('cuenta_beneficiaria') is-invalid @enderror" aria-label="" style="width: 100%" required="">
                                <option selected value="">
                                    Seleccione la cuenta beneficiaria
                                </option>
                                @foreach ($cuentas as $cuenta)
                                    @if($cuenta->tipomoneda->nombre == 'SOLES')
                                    <option value="{{ $cuenta->id }}" {{ old('cuenta_beneficiaria') == $cuenta->id ? 'selected' : '' }}>
                                        {{ $cuenta->nombre }}
                                    </option>
                                    @endif
                        ...
                        <div class="form-group col-md-6 g-3">
                            ...
                            <br>
                            <select name="tipo_comprobante_id" id="tipo_comprobante2" class="form-control form-control-sm buscador @error('tipo_comprobante') is-invalid @enderror" aria-label="" style="width: 100%" >
                                <option value="">
                        ...
                        <div class="form-group col-md-12 g-3">
                            ...
                            <br>
                            <select name="motivo_id" id="motivo2" class="form-control form-control-sm buscador @error('motivo1') is-invalid @enderror" aria-label="" style="width: 100%" required>
                                <option selected value="">
