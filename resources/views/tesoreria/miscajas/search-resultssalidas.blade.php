    ...
    @foreach ($salidascajas as $salidacaja)
        <tr>
            ...
            <td class="btn-group align-items-center">
                <div>
                    <a href="#" data-toggle="modal" data-target="#ModalEditar{{ $salidacaja->id }}"
                        class="">
                ...
                <div class="">
                    <form class="eliminar-registro" action="{{ route('tssalidascajas.destroy', $salidacaja->id) }}"
                ...
                <div class="" style="margin-top: -18px; margin-left:2.5px">
                    <a href="{{ route('tsmiscajas.printdocsalida', $salidacaja->id) }}" class="btnprn"
