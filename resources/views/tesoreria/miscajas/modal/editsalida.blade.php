<div class="modal fade text-left" id="ModalEditar{{ $salidacaja->id }}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="card-body">
                <form class="editar-salidacuenta" action="{{ route('tssalidascajas.update', $salidacaja->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="form mb-1 col-md-4">
                            <label for="documento_beneficiario" class="text-sm">{{ __('DOC. BENEFICIARIO') }}</label>
                            <input disabled name="documento_beneficiario"
                                value="{{ $salidacaja->beneficiario ? $salidacaja->beneficiario->documento : '' }}"
                        ...
                        <div class="form col-md-8 mb-2">
                            ...
                            <input disabled name="nombre_beneficiario"
                                value="{{ $salidacaja->beneficiario ? $salidacaja->beneficiario->nombre : '' }}"
                        ...
                        <div class="form-group col-md-5 g-3">
                            ...
                            <input disabled name="tipo_comprobante"
                                value="{{ $salidacaja->tipocomprobante ? $salidacaja->tipocomprobante->nombre : '' }}"
                        ...
                        <div class="form-group col-md-4 g-3">
                            ...
                            <br>
                            <input disabled name="tipo_comprobante"
                                value="{{ $salidacaja->comprobante_correlativo ? $salidacaja->comprobante_correlativo : '' }}"
                        ...
                        <div class="form col-md-3 mb-3">
                            ...
                            <input name="fecha_comprobante" id="fecha_comprobante" class="form-control form-control-sm"
                                value="{{ $salidacaja->fecha_comprobante ? date('Y-m-d', strtotime($salidacaja->fecha_comprobante)) : '' }}"
                                disabled placeholder="Ingrese la fecha" type="date">
                        ...
                        <div class="form-group col-md-6 g-3">
                            ...
                            <input disabled name="cuenta"
                                value="{{ $salidacaja->caja ? $salidacaja->caja->nombre : '' }}" id="tipo_comprobante"
                                class=" form-control form-control-sm" placeholder="Cuenta..." type="text">
                        ...
                        <div class="form-group col-md-6 g-3">
                            ...
                            <input disabled name="motivo"
                                value="{{ $salidacaja->motivo ? $salidacaja->motivo->nombre : '' }}" id="motivo"
                        ...
                        <div class="form-group col-md-12 g-3">
                            ...
                            <input name="descripcion"
                                value="{{ $salidacaja->descripcion ? $salidacaja->descripcion : '' }}" id="descripcion"
                        ...
                        <div class="form-group  col-md-12 g-3">
                            ...
                            <input type="text" value="{{ $salidacaja->monto }}" name="monto" id="monto"
