<div class="modal fade text-left" id="ModalIngreso" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="card-header">
                <div class="row justify-content-between">
                    <div class="col-md-6">
                        <h6 class="mt-2">
                            {{ __('REGISTRAR INGRESO A LA CAJA') }}
                        </h6>
                    </div>
            ...
            <div class="card-body">
                <form class="crear-cuenta" action="{{ route('tsingresoscajas.store') }}" method="POST">
                    @csrf
                    <div class="row">

                        <div class="form mb-1 col-md-4">
                            <input name="documento" id="documentoc" class="form-control form-control-sm" placeholder="Documento de quien entrega..." type="text">
                            <span class="input-border"></span>
                        </div>   
    
                        <div class="form col-md-8 mb-2">
                            <input name="nombre" id="nombrec" class="form-control form-control-sm" placeholder="Valide el nombre de quien entrega..." type="text">
                            <span class="input-border"></span>
                        </div>
...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#documentoc').on('input', function() {
                var inputLength = $(this).val().length;
                if (inputLength === 8 || inputLength === 11) {
                    buscarDocumento('{{ route('buscar.documento') }}', '#documentoc', '#nombrec');
                }
            });
