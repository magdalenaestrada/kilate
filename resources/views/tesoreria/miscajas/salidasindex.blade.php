...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" class="form-control form-control-sm" style="margin-top: -8px"
                                name="hasta" id="hasta"
                                value="{{ old('hasta', request('desde', \Carbon\Carbon::today()->format('Y-m-d'))) }}" />
                        </div>
                    ...
                    <div class="card-body table-responsive">
                        ...
                        <table id="salidasmiscajas-table" class="table table-striped text-center ">
                            <thead>
                                <tr>
                                    <th scope="col">
                                        {{ __('FECHA') }}
                                        ...
                                        <tr>
                                            ...
                                            <td scope="row">
                                                @if ($salidacaja->tipocomprobante)
                                                    {{ $salidacaja->tipocomprobante->nombre }}
                                                @endif
                                            </td>
                                            ...
                                            <td scope="row">
                                                @if ($salidacaja->reposicion_id)
                                                    {{ $salidacaja->reposicion_id }}
                                                @endif
                                            ...
                                            <td scope="row">
                                                @if ($salidacaja->beneficiario)
                                                    {{ $salidacaja->beneficiario->nombre }}
                                                @endif
                                            ...
                                            <td class="btn-group align-items-center">
                                                <div>
                                                    <a href="#" data-toggle="modal"
                                                        data-target="#ModalEditar{{ $salidacaja->id }}" class="">
                                                ...
                                                <div class="">
                                                    <form class="eliminar-registro"
                                                        action="{{ route('tssalidascajas.destroy', $salidacaja->id) }}"
                                                ...
                                                <div class="" style="margin-top: -18px; margin-left:2.5px">
                                                    <a href="{{ route('tsmiscajas.printdocsalida', $salidacaja->id) }}"
    ...
    @foreach ($salidascajas as $salidacaja)
        @include('tesoreria.miscajas.modal.editsalida')
    @endforeach
...
@section('js')
    ...
    <script>
        ...
        $('.eliminar-registro').submit(function(e) {
            e.preventDefault();
            Swal.fire({
                title: '¿Eliminar Salida de la caja?',
                text: 'Esta seguro que quiere eliminar esta salida de la caja?',
                icon: 'warning',
        ...
        $(document).ready(function() {
            ...
            function searchReports() {
                ...
                $.ajax({
                    url: "{{ route('search.salidasmiscajas') }}",
                    method: 'GET',
                    data: {
