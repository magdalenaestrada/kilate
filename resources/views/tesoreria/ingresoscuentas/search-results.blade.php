@if (count($ingresoscuentas) > 0)
    @foreach ($ingresoscuentas as $ingresocuenta)
        <tr class="text-center">
            ...
            <td>
                @php
                    $coin_simbol = $ingresocuenta->cuenta->tipomoneda->nombre == 'DOLARES' ? '$' : 'S/.';
                @endphp
            ...
            @can('edit cuenta')
                <td class="d-flex align-items-center">
                    ...
                    <a href="{{ route('tsingresoscuentas.printdoc', $ingresocuenta->id) }}" class="btnprn"
                    ...
                    <a href="#" data-toggle="modal" data-target="#ModalEditar{{ $ingresocuenta->id }}"
                        class="">
                    ...
                    <div class="">
                        <form class="eliminar-registro"
                            action="{{ route('tsingresoscuentas.destroy', $ingresocuenta->id) }}" method="POST"
