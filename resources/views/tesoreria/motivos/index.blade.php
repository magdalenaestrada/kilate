...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body ">
                                        ...
                                        <tr>
                                            ...
                                            {{-- <td class="btn-group">
                                                ...
                                                <a href="#" data-toggle="modal"
                                                    data-target="#ModalEdit{{ $motivo->id }}" class="ml-1">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                Mostrando del {{ $motivos->firstItem() }} al {{ $motivos->lastItem() }} de
                                {{ $motivos->total() }} registros
                            </div>
                        </div>
    ...
    @include('tesoreria.motivos.modal.create')
