    ...
    @foreach ($inventarioingresos as $inventarioingreso)
        <tr>
            ...
            <td scope="row" class="text-center">
                                                            {{ $inventarioingreso->total }}
            </td>

            <td scope="row" class="text-center">
                                                {{ $inventarioingreso->tipomoneda }}
            </td>
            ...
            <td>
                <div  class="btn-group align-items-center">
                                                ...
                                                <a class="btn btn-secondary btn-sm" href="{{ route('inventarioingresos.show', [$inventarioingreso->id]) }}" data-toggle="modal" data-target="#ModalShow{{ $inventarioingreso->id}}" class="btn btn-secondary btn-sm" >
                                                    {{ __('VER') }}
                                                </a>
                                                ...
                                                <a  class="btn btn-primary btn-sm" href="{{route('inventarioingresos.cancelar', $inventarioingreso->id) }}" style="margin-left: 5px;">
                                                {{ __('CANCELAR') }}</a>
                                                @endif
                                                @if ($inventarioingreso->estado == 'POR RECOGER' && $inventarioingreso->estado !== 'ANULADO')
                                                <a class="btn btn-warning btn-sm" href="{{ route('inventarioingresos.recepcionar', [$inventarioingreso->id]) }}"  data-toggle="modal" data-target="#ModalRecepcionar{{ $inventarioingreso->id}}"  style="margin-left: 5px;">
                                                    {{ __('RECEPCIONAR') }}
                                                </a>
                                                @endif
                                                @if ($inventarioingreso->estado_pago == 'PENDIENTE AL CRÉDITO' && $inventarioingreso->estado !== 'ANULADO')
                                                <a class="btn btn-info btn-sm" href="{{ route('inventarioingresos.cancelaralcredito', [$inventarioingreso->id]) }}" data-toggle="modal" data-target="#ModalCancelarCredito{{ $inventarioingreso->id}}" style="margin-left: 5px;">
                                                    {{ __('CANCELAR ORDEN AL CRÉDITO') }}
                                                </a>
                                                @endif
                                                @if ($inventarioingreso->estado_pago == 'PENDIENTE A CUENTA' && $inventarioingreso->estado !== 'ANULADO')
                                                <a class="btn btn-success btn-sm" href="{{ route('inventarioingresos.cancelaracuenta', [$inventarioingreso->id]) }}" data-toggle="modal" data-target="#ModalCancelarACuenta{{ $inventarioingreso->id}}" style="margin-left: 5px;">
                                                    {{ __('CANCELAR ORDEN A CUENTA') }}
                                                </a>
                                                @endif
                                                ...
                                                <a href="{{ route('inventarioingreso.prnpriview', $inventarioingreso->id) }}" class="btnprn" style="margin-left: 5px;">
                                                ...
                                                @if ($inventarioingreso->estado !== 'INGRESADO AL ALMACEN' && $inventarioingreso->estado !== 'ANULADO')
                                                <a href="{{ route('inventarioingresos.anular', $inventarioingreso->id) }}" class="bin-button btn anular anular-orden-compra" style="margin-left: 5px;">
                                                    <svg
