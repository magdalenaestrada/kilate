            ...
            <td class="btn-group  align-items-center ">
                ...
                <div>
                    <a class="btn btn-secondary btn-sm"
                        href="{{ route('inventarioingresos.show', [$inventarioingreso->id]) }}" data-toggle="modal"
                        data-target="#ModalShow{{ $inventarioingreso->id }}" class="btn btn-secondary btn-sm">
                        {{ __('VER') }}
                    </a>
                </div>
                @if ($inventarioingreso->estado !== 'ANULADO')
                    <div>
                        <a class="btn btn-outline-warning btn-sm"
                            ...
                            style="margin-left: 5px;" title="Editar cotización">
                ...
                <div class="">
                    @if ($inventarioingreso->estado == 'POR RECOGER' && $inventarioingreso->estado !== 'ANULADO')
                        <a class="btn btn-warning btn-sm"
                            ...
                            data-toggle="modal" data-target="#ModalRecepcionar{{ $inventarioingreso->id }}"
                            style="margin-left: 5px;">
                            {{ __('RECEPCIONAR') }}
                        </a>
                    @endif
                ...
                <div class="">
                    @if ($inventarioingreso->estado_pago == 'PENDIENTE AL CRÉDITO' && $inventarioingreso->estado !== 'ANULADO')
                        <a class="btn btn-info btn-sm"
                            ...
                            data-toggle="modal" data-target="#ModalCancelarCredito{{ $inventarioingreso->id }}"
                            style="margin-left: 5px;">
                ...
                <div class="">
                    ...
                    @if ($inventarioingreso->estado_pago == 'PENDIENTE A CUENTA' && $inventarioingreso->estado !== 'ANULADO')
                        <a class="btn btn-success btn-sm"
                            ...
                            data-toggle="modal" data-target="#ModalCancelarACuenta{{ $inventarioingreso->id }}"
                            style="margin-left: 5px;">
                ...
                <div class="ml-1" style="margin-top: -10px">
                    <a href="{{ route('inventarioingreso.prnpriview', $inventarioingreso->id) }}" class="btnprn"
                        style="margin-left: 5px;">
                        <div class="printer">
                            <div class="paper">
                ...
                <div class="">
                    @if ($inventarioingreso->estado !== 'ANULADO')
                        <a href="{{ route('inventarioingresos.anular', $inventarioingreso->id) }}"
                            class="bin-button btn anular anular-orden-compra" style="margin-left: 5px;">
