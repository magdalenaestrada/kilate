                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <form action="{{ route('inventarioingresos.updatecancelaralcredito', $inventarioingreso->id) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="form-group col-md-5 g-3">
                                        <label for="fecha_pago_al_credito">
                                            {{ __('FECHA DE CANCELACIÓN AL CRÉDITO') }}
                                        </label>
                                        <input class="form-control" type="datetime-local" name="fecha_pago_al_credito">
                                    </div>
