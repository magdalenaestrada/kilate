...
class DetalleInventarioSalidaRapidaExport implements FromCollection, WithHeadings, WithMapping
{
    ...
    public function __construct($destino = null, $nombre_solicitante = null, $producto_id = null, $start_date = null, $end_date = null, $precio = null)
    {
    ...
    public function map($detalle): array
    {
        return [
            ...
            $detalle->cantidad,
            optional($detalle->producto)->precio ?? '-',
            optional($detalle->producto)->precio * $detalle->cantidad?? '-',
